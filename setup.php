...
<form method="post" action="setup.php?step=2">
	...
	<table class="form-table">
		...
		<tr><th scope="row"><label for="t_url">网址</label></th><td><input name="t_url" id="t_url" type="text" value="<?php echo BASE_URL; ?>" size="35" /></td><td>一般不需要修改，如需自动适应（如多网址同一网站）请留空</td></tr>
